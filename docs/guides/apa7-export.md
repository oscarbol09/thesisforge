...
2. **Tipografía y Espaciado:**
   ...
   - Interlineado doble (2.0) en todo el cuerpo del documento.
   - Márgenes de 2.54 cm (1 pulgada) en los 4 bordes.
3. **Encabezados Jerárquicos (Nivel 1 al 5):**
...
4. **Tablas y Figuras:**
   - Título de tabla en cursiva arriba de la tabla.
   - Sanitización contra inyección de fórmulas para proteger la apertura del archivo en suites ofimáticas.
